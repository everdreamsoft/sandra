...
class ComposerStaticInitaf125a87073de8f3b61a9f7ec1886a14
{
    ...
    public static $prefixDirsPsr4 = array (
        ...
        'TomWright\\PHPConfig\\' => 
        array (
            0 => __DIR__ . '/..' . '/tomwright/php-config/src',
        ),
        'TomWright\\JSON\\' => 
        array (
            0 => __DIR__ . '/..' . '/tomwright/json/src',
        ),
    ...
    public static $classMap = array (
        ...
        'TomWright\\JSON\\Exception\\JSONDecodeException' => __DIR__ . '/..' . '/tomwright/json/src/Exception/JSONDecodeException.php',
        'TomWright\\JSON\\Exception\\JSONEncodeException' => __DIR__ . '/..' . '/tomwright/json/src/Exception/JSONEncodeException.php',
        'TomWright\\JSON\\Exception\\JSONException' => __DIR__ . '/..' . '/tomwright/json/src/Exception/JSONException.php',
        'TomWright\\JSON\\JSON' => __DIR__ . '/..' . '/tomwright/json/src/JSON.php',
        'TomWright\\PHPConfig\\Config' => __DIR__ . '/..' . '/tomwright/php-config/src/Config.php',
        'TomWright\\PHPConfig\\ConfigReader\\ConfigReader' => __DIR__ . '/..' . '/tomwright/php-config/src/ConfigReader/ConfigReader.php',
        'TomWright\\PHPConfig\\ConfigReader\\FileReader' => __DIR__ . '/..' . '/tomwright/php-config/src/ConfigReader/FileReader.php',
        'TomWright\\PHPConfig\\ConfigReader\\InvalidConfigFileException' => __DIR__ . '/..' . '/tomwright/php-config/src/ConfigReader/InvalidConfigFileException.php',
        'TomWright\\PHPConfig\\ConfigReader\\InvalidFilePathException' => __DIR__ . '/..' . '/tomwright/php-config/src/ConfigReader/InvalidFilePathException.php',
        'TomWright\\PHPConfig\\ConfigReader\\JSON\\JSONFileReader' => __DIR__ . '/..' . '/tomwright/php-config/src/ConfigReader/JSON/JSONFileReader.php',
        'TomWright\\PHPConfig\\ConfigReader\\PHP\\PHPFileReader' => __DIR__ . '/..' . '/tomwright/php-config/src/ConfigReader/PHP/PHPFileReader.php',
        'TomWright\\PHPConfig\\Exception' => __DIR__ . '/..' . '/tomwright/php-config/src/Exception.php',
